...
#### 2. Download the Lineage OS 17.0 source code
...
```bash
git clone https://github.com/mt8163/android_device_amazon_karnak
git clone https://github.com/mt8163/android_kernel_amazon_karnak
git clone https://github.com/mt8163/android_vendor_amazon_karnak
```
